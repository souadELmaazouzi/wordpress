...
<main class="main">
    ...
    <section id="hero" class="hero section light-background">
      ...
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/hero.jpeg" alt="">
...
<div class="container" data-aos="fade-up" data-aos-delay="100">
  ...
  <div class="row gy-4 justify-content-center">
    <div class="col-lg-4">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/profile.jpg" class="img-fluid" alt="">
    </div>
        ...
        <div class="testimonial-item">
          <div class="row gy-4 justify-content-center">
            ...
            <div class="col-lg-2 text-center">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonials-4.jpg" alt="" class="img-fluid testimonial-img" >
            </div>
          </div>
        </div>
      ...
      <div class="swiper-slide">
        <div class="testimonial-item">
          <div class="row gy-4 justify-content-center">
            ...
            <div class="col-lg-2 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonials-3.jpg" alt="" class="img-fluid testimonial-img" >
            </div>
          </div>
        </div>
      </div><!-- End testimonial item -->
      ...
      <div class="swiper-slide">
        <div class="testimonial-item">
          <div class="row gy-4 justify-content-center">
            ...
            <div class="col-lg-2 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonials-2.jpg" alt="" class="img-fluid testimonial-img" >
            </div>
          </div>
        </div>
      </div><!-- End testimonial item -->
      ...
      <div class="swiper-slide">
        <div class="testimonial-item">
          <div class="row gy-4 justify-content-center">
            ...
            <div class="col-lg-2 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonials-1.jpg" alt="" class="img-fluid testimonial-img" >
            </div>
          </div>
        </div>
      </div><!-- End testimonial item -->
